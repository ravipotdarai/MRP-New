...
object EventTypes {
    ...
    const val CONTENT_DOMAIN_BLOCKED = "CONTENT_DOMAIN_BLOCKED"
    const val SAFE_LINK_FALSE_POSITIVE = "SAFE_LINK_FALSE_POSITIVE"
    const val VAULT_EXPIRY_REMINDER = "VAULT_EXPIRY_REMINDER"
    ...
    const val BREACH_EMAIL_FOUND = "BREACH_EMAIL_FOUND"
    const val BREACH_EMAIL_CLEAN = "BREACH_EMAIL_CLEAN"
