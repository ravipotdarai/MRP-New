...
export const DIGITAL_SAFETY_EVENT_TYPES = {
  ...
  NETWORK_GUARDIAN_ENABLED: 'NETWORK_GUARDIAN_ENABLED',
  NETWORK_GUARDIAN_DISABLED: 'NETWORK_GUARDIAN_DISABLED',
  AD_BLOCKED: 'AD_BLOCKED',
  TRACKER_BLOCKED: 'TRACKER_BLOCKED',
  MALICIOUS_DOMAIN_BLOCKED: 'MALICIOUS_DOMAIN_BLOCKED',
  SCAM_DETECTED: 'SCAM_DETECTED',
  QR_SCANNED: 'QR_SCANNED',
  QR_BLOCKED: 'QR_BLOCKED',
  CELLULAR_ANOMALY_DETECTED: 'CELLULAR_ANOMALY_DETECTED',
  BREACH_EMAIL_FOUND: 'BREACH_EMAIL_FOUND',
