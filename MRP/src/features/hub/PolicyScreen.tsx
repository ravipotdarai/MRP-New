...
const SECTIONS: {title: string; body: string[]}[] = [
  {
    ...
    body: [
      'MRP (Mobile Resilience & Platform) is a personal device-security app. Your security data — timeline events, intruder selfies, geofence state, and location used for those features — stays on your device by default.',
      ...
      'Optional Google sign-in is used for account features and sync policy. MRP does not use your Google account to list or read your personal Drive files outside the app-owned folder.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'Disconnect Google and delete MRP-linked account data by signing out and requesting account deletion via support if you used cloud account features.',
  ...
  },
  {
    ...
    body: [
      ...
      'MRP holds authentication and sync policy configuration. Raw GPS event feeds intended for multi-user live share are not used in the v1 Drive-only release.',
      'API access requires a valid MRP ID token and ownership checks. “No one can hack through MRP” is a hardening goal, not an absolute guarantee — stolen PIN or a compromised device remain out of scope.',
    ],
  },
  {
