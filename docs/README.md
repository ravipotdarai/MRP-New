...
Project documentation (moved out of the repo root).
...
| Doc | Description |
|---|---|
| [INSTALLATION.md](setup/INSTALLATION.md) | Sideload / debug install |
| [ONBOARDING.md](setup/ONBOARDING.md) | First-run wizard and feature enablement |
| [PERMISSIONS_AND_TRUST.md](setup/PERMISSIONS_AND_TRUST.md) | Why each permission, ⋮ menu path, OEM notes |
